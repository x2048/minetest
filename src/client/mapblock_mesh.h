...
void final_color_blend(video::SColor *result,
		u16 light, u32 daynight_ratio, const AmbientLight *ambientLight = nullptr);
 ...
 */
void final_color_blend(video::SColor *result,
		const video::SColor &data, const video::SColorf &dayLight, const AmbientLight *ambientLight = nullptr);
