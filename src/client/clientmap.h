...
public:
	...
	{
		v3s16 previous_node = floatToInt(m_camera_position + intToFloat(m_camera_offset, BS), BS);
		...
		v3s16 current_node = floatToInt(m_camera_position + intToFloat(m_camera_offset, BS), BS);
